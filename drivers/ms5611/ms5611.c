...
uint8_t MS5611_read_temp(I2C_HandleTypeDef* I2Cx, MS5611_t* datastruct, uint8_t resolution)
{
	...
	switch (resolution)
	{
	case MS5611_CMD_CONVERT_D2_256:
		cmd = MS5611_CMD_CONVERT_D2_256;
		conv_T = 1;
		break;
	case MS5611_CMD_CONVERT_D2_512:
		cmd = MS5611_CMD_CONVERT_D2_512;
		conv_T = 2;
		break;
	case MS5611_CMD_CONVERT_D2_1024:
		cmd = MS5611_CMD_CONVERT_D2_1024;
		conv_T = 3;
		break;
	case MS5611_CMD_CONVERT_D2_2048:
		cmd = MS5611_CMD_CONVERT_D2_2048;
		conv_T = 5;
		break;
	case MS5611_CMD_CONVERT_D2_4096:
...
uint8_t MS5611_read_press(I2C_HandleTypeDef* I2Cx, MS5611_t* datastruct, uint8_t resolution)
{
	...
	switch (resolution)
	{
	case MS5611_CMD_CONVERT_D1_256:
		cmd = MS5611_CMD_CONVERT_D1_256;
		conv_T = 1;
		break;
	case MS5611_CMD_CONVERT_D1_512:
		cmd = MS5611_CMD_CONVERT_D1_512;
		conv_T = 2;
		break;
	case MS5611_CMD_CONVERT_D1_1024:
		cmd = MS5611_CMD_CONVERT_D1_1024;
		conv_T = 3;
		break;
	case MS5611_CMD_CONVERT_D1_2048:
		cmd = MS5611_CMD_CONVERT_D1_2048;
		conv_T = 5;
		break;
	case MS5611_CMD_CONVERT_D1_4096:
