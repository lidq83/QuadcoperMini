...
static uint8_t dmpReady = 0; // set true if DMP init was successful
...
int mpu6050_setup(void)
{
	...
	{
		// k_printf("MPU6050 connection failed\n");
		return -1;
	}
	// k_printf("MPU6050 connection successful\n");
...
uint8_t devAddr = MPU6050_ADDRESS_DEFAULT;
uint8_t buffer[14];

uint8_t mpu6050_dmpMemory[MPU6050_DMP_CODE_SIZE] =
{
		// bank 0, 256 bytes
...
uint8_t mpu6050_dmpConfig[MPU6050_DMP_CONFIG_SIZE] =
{
//  BANK    OFFSET  LENGTH  [DATA]
		...
		0x02, 0x16, 0x02, 0x00,
		DMP_FIFO_RATE // D_0_22 inv_set_fifo_rate
		};

uint8_t mpu6050_dmpUpdates[MPU6050_DMP_UPDATES_SIZE] =
...
{
	mpu6050_reset();
	MPU6050_DELAY(30); // wait after reset
...
uint8_t mpu6050_dmpGetQuaternionInt16(short *data, uint8_t *packet)
{
	if (packet == 0)
	{
		return 0;
...
uint8_t mpu6050_dmpGetQuaternion(Quaternion *q, uint8_t *packet)
{
	short qI[4];
...
uint8_t mpu6050_dmpGetAccel(VectorInt16 *v, uint8_t *packet)
{
	if (packet == 0)
	{
		return 0;
 ...
 */
int mpu6050_getAccelXSelfTest(void)
{
 ...
 * @see MPU6050_RA_ACCEL_CONFIG
 */
int mpu6050_getAccelYSelfTest(void)
{
 ...
 * @see MPU6050_RA_ACCEL_CONFIG
 */
int mpu6050_getAccelZSelfTest(void)
{
 ...
 */
int mpu6050_getTempFIFOEnabled(void)
{
 ...
 * @see MPU6050_RA_FIFO_EN
 */
int mpu6050_getXGyroFIFOEnabled(void)
{
 ...
 * @see MPU6050_RA_FIFO_EN
 */
int mpu6050_getYGyroFIFOEnabled(void)
{
 ...
 * @see MPU6050_RA_FIFO_EN
 */
int mpu6050_getZGyroFIFOEnabled(void)
{
 ...
 * @see MPU6050_RA_FIFO_EN
 */
int mpu6050_getAccelFIFOEnabled(void)
{
 ...
 * @see MPU6050_RA_FIFO_EN
 */
int mpu6050_getSlave2FIFOEnabled(void)
{
 ...
 * @see MPU6050_RA_FIFO_EN
 */
int mpu6050_getSlave1FIFOEnabled(void)
{
 ...
 * @see MPU6050_RA_FIFO_EN
 */
int mpu6050_getSlave0FIFOEnabled(void)
{
 ...
 */
int mpu6050_getMultiMasterEnabled(void)
{
 ...
 * @see MPU6050_RA_I2C_MST_CTRL
 */
int mpu6050_getWaitForExternalSensorEnabled(void)
{
 ...
 */
int mpu6050_getSlave3FIFOEnabled(void)
{
 ...
 * @see MPU6050_RA_I2C_MST_CTRL
 */
int mpu6050_getSlaveReadWriteTransitionEnabled(void)
{
 ...
 */
int mpu6050_getSlave4Enabled(void)
{
 ...
 * @see MPU6050_RA_I2C_SLV4_CTRL
 */
int mpu6050_getSlave4InterruptEnabled(void)
{
 ...
 * @see MPU6050_RA_I2C_SLV4_CTRL
 */
int mpu6050_getSlave4WriteMode(void)
{
 ...
 */
int mpu6050_getPassthroughStatus(void)
{
 ...
 * @see MPU6050_RA_I2C_MST_STATUS
 */
int mpu6050_getSlave4IsDone(void)
{
 ...
 * @see MPU6050_RA_I2C_MST_STATUS
 */
int mpu6050_getLostArbitration(void)
{
 ...
 * @see MPU6050_RA_I2C_MST_STATUS
 */
int mpu6050_getSlave4Nack(void)
{
 ...
 * @see MPU6050_RA_I2C_MST_STATUS
 */
int mpu6050_getSlave3Nack(void)
{
 ...
 * @see MPU6050_RA_I2C_MST_STATUS
 */
int mpu6050_getSlave2Nack(void)
{
 ...
 * @see MPU6050_RA_I2C_MST_STATUS
 */
int mpu6050_getSlave1Nack(void)
{
 ...
 * @see MPU6050_RA_I2C_MST_STATUS
 */
int mpu6050_getSlave0Nack(void)
{
 ...
 */
int mpu6050_getInterruptMode(void)
{
 ...
 */
int mpu6050_getInterruptDrive(void)
{
 ...
 */
int mpu6050_getInterruptLatch(void)
{
 ...
 */
int mpu6050_getInterruptLatchClear(void)
{
 ...
 */
int mpu6050_getFSyncInterruptLevel(void)
{
 ...
 */
int mpu6050_getFSyncInterruptEnabled(void)
{
 ...
 */
int mpu6050_getI2CBypassEnabled(void)
{
 ...
 */
int mpu6050_getClockOutputEnabled(void)
{
 ...
 * @see MPU6050_INTERRUPT_FF_BIT
 **/
int mpu6050_getIntFreefallEnabled(void)
{
 ...
 **/
int mpu6050_getIntMotionEnabled(void)
{
 ...
 **/
int mpu6050_getIntZeroMotionEnabled(void)
{
 ...
 **/
int mpu6050_getIntFIFOBufferOverflowEnabled(void)
{
 ...
 **/
int mpu6050_getIntI2CMasterEnabled(void)
{
 ...
 */
int mpu6050_getIntDataReadyEnabled(void)
{
 ...
 * @see MPU6050_INTERRUPT_FF_BIT
 */
int mpu6050_getIntFreefallStatus(void)
{
 ...
 * @see MPU6050_INTERRUPT_MOT_BIT
 */
int mpu6050_getIntMotionStatus(void)
{
 ...
 * @see MPU6050_INTERRUPT_ZMOT_BIT
 */
int mpu6050_getIntZeroMotionStatus(void)
{
 ...
 * @see MPU6050_INTERRUPT_FIFO_OFLOW_BIT
 */
int mpu6050_getIntFIFOBufferOverflowStatus(void)
{
 ...
 * @see MPU6050_INTERRUPT_I2C_MST_INT_BIT
 */
int mpu6050_getIntI2CMasterStatus(void)
{
 ...
 * @see MPU6050_INTERRUPT_DATA_RDY_BIT
 */
int mpu6050_getIntDataReadyStatus(void)
{
 ...
 * @param ax 16-bit integer container for accelerometer X-axis value
 * @param ay 16-bit integer container for accelerometer Y-axis value
 * @param az 16-bit integer container for accelerometer Z-axis value
 * @param gx 16-bit integer container for gyroscope X-axis value
 * @param gy 16-bit integer container for gyroscope Y-axis value
 * @param gz 16-bit integer container for gyroscope Z-axis value
 * @param mx 16-bit integer container for magnetometer X-axis value
 * @param my 16-bit integer container for magnetometer Y-axis value
 * @param mz 16-bit integer container for magnetometer Z-axis value
 * @see getMotion6()
 * @see getAcceleration()
 * @see getRotation()
 ...
 * </pre>
 *
 * @param x 16-bit integer container for X-axis acceleration
 * @param y 16-bit integer container for Y-axis acceleration
 * @param z 16-bit integer container for Z-axis acceleration
 ...
 * </pre>
 *
 * @param x 16-bit integer container for X-axis rotation
 * @param y 16-bit integer container for Y-axis rotation
 * @param z 16-bit integer container for Z-axis rotation
 * @see getMotion6()
 * @see MPU6050_RA_GYRO_XOUT_H
 */
 ...
 */
int mpu6050_getXNegMotionDetected(void)
{
 ...
 */
int mpu6050_getXPosMotionDetected(void)
{
 ...
 */
int mpu6050_getYNegMotionDetected(void)
{
 ...
 */
int mpu6050_getYPosMotionDetected(void)
{
 ...
 */
int mpu6050_getZNegMotionDetected(void)
{
 ...
 */
int mpu6050_getZPosMotionDetected(void)
{
 ...
 */
int mpu6050_getExternalShadowDelayEnabled(void)
{
 ...
 */
int mpu6050_getFIFOEnabled(void)
{
 ...
 */
int mpu6050_getI2CMasterModeEnabled(void)
{
 ...
 */
int mpu6050_getSleepEnabled(void)
{
 ...
 */
int mpu6050_getWakeCycleEnabled(void)
{
 ...
 */
int mpu6050_getTempSensorEnabled(void)
{
 ...
 */
int mpu6050_getStandbyXAccelEnabled(void)
{
 ...
 */
int mpu6050_getStandbyYAccelEnabled(void)
{
 ...
 */
int mpu6050_getStandbyZAccelEnabled(void)
{
 ...
 */
int mpu6050_getStandbyXGyroEnabled(void)
{
 ...
 */
int mpu6050_getStandbyYGyroEnabled(void)
{
 ...
 */
int mpu6050_getStandbyZGyroEnabled(void)
{
...
int mpu6050_getIntPLLReadyEnabled(void)
{
...
int mpu6050_getIntDMPEnabled(void)
{
...
int mpu6050_getDMPEnabled(void)
{
