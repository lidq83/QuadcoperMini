...
#define NRF_CSN_HIGH() GPIO_SetBits(GPIOB, GPIO_Pin_1)
#define NRF_CSN_LOW() GPIO_ResetBits(GPIOB, GPIO_Pin_1)
#define NRF_CE_HIGH() GPIO_SetBits(GPIOB, GPIO_Pin_0)
#define NRF_CE_LOW() GPIO_ResetBits(GPIOB, GPIO_Pin_0)
#define NRF_Read_IRQ() GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_10)
